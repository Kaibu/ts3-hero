...
<table id="info">
  ...
  <tr>
    ...
    <td><img height="14" width="14" src="styles:/Hero/gui/platform/%%CLIENT_PLATFORM%%.png" title="%%CLIENT_PLATFORM%%"></td>
  </tr>
  <tr>
    <td class="label">Client Icon:</td>
    <td><img src="%%?CLIENT_ICON%%" alt="" title="Client Icon"/></td>
  </tr>
</table>
