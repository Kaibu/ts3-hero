...
<table id="info">
  ...
  <tr>
    <td class="label">Qualité du codec :</td>
  ...
  <tr><td class="label">Clients actuels :</td><td>%%?CHANNEL_CLIENTS_COUNT%% / %%CHANNEL_FLAG_MAXCLIENTS%%</td></tr>
  <tr><td class="label">Pouvoir de discussion nécessaire :</td><td class="red"><img src="iconpath:MODERATED?size=16x16" height="12" width="12" alt="" title="Request Talk Power to be able to talk in this Channel." />&nbsp;&nbsp;%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr>
  <tr>
    <td class="label">Abonnement :</td>
    <td>%%CHANNEL_SUBSCRIPTION%%</td>
  </tr>
  <tr><td class="label">Cryptage des données vocales :</td><td>%%CHANNEL_VOICE_DATA_ENCRYPTED%%</td></tr>
  %%?PLUGIN_INFO_DATA%%
</table>

<p style="margin-top: 4px; color:darkRed;">Le canal sera supprimé dans %%?TEMP_CHANNEL_TIME_TO_DELETE%%.</p>
